 ...
 * Assignment 3.1
 * Description:
 * Static OMP scheduling probe. This executable
 ...
 * under static scheduling conditions (chuck
 * size = 4)
 *
 * example:
 *
 ...
 *
 * output:
 * Thread 0: Iterations 0 – 3, 8 – 11, 16 – 19, 24 – 27
 * Thread 1: Iterations 4 – 7, 12 – 15, 20 – 23, 28 – 31
 */

#define DEFAULT_ITER 32
...
#pragma omp parallel for \
    ...
    schedule(static , DEFAULT_CHUNK_SIZE) \
    default(none) \
    private(index) \
    shared(thread_tracker, no_iter, no_threads)
